...
RSpec.describe NA86::Unit do
  ...
  before( :each ) do
    ...
    @ship_combat.attach_weapon( NA86::WeaponMount.new( NA86::Ordnance::TYPE_HARPOON_SSM, 8, 16 ) )
    @ship_combat.attach_weapon( NA86::WeaponMount.new( NA86::Ordnance::TYPE_STANDARD, 4, 68 ) )
    @ship_combat.attach_weapon( NA86::WeaponMount.new( NA86::Ordnance::TYPE_ASROC, 1, 20 ) )
    @ship_combat.attach_weapon( NA86::WeaponMount.new( NA86::Ordnance::TYPE_MK46_TORPEDO, 2, 6 ) )
    @ship_carrier = NA86::Unit.new( ship_carrier_params )
    @ship_transport = NA86::Unit.new( ship_transport_params )
    @ship_submarine = NA86::Unit.new( ship_submarine_params )
    ...
    @group_bombardment = NA86::Group.new( group_bombardment_params )
    @group_submarine = NA86::Group.new( group_submarine_params )
  end
  ...
  context "attributes" do
    ...
    it "should have a status" do
      @ship_combat.status.should == NA86::Unit::STATUS_IN_PIPELINE
    end
  end
  ...
  context "when taking damange" do
    it "should withstand sinking if damage taken is less than maximum allowed damage and it is combat ship" do
      ...
      @ship_combat.status.should_not == NA86::Unit::STATUS_SUNK
    end
    ...
    it "should be scuttled" do
      @ship_combat.attach @group_combat
      @ship_combat.scuttle
      @ship_combat.status.should == NA86::Unit::STATUS_SCUTTLED
  ...
  context "cargo" do
    ...
    it "should not have more troops than cargo capacity" do
      lambda { @ship_transport.load_troops( 100 ) }.should raise_error( NA86::Exceptions::NotEnoughCargoCapacity )
    end

    it "should not have more supplies than cargo capacity" do
      lambda { @ship_transport.load_supplies( 100 ) }.should raise_error( NA86::Exceptions::NotEnoughCargoCapacity )
    end

    it "should not have more troops and supplies than cargo capacity" do
      lambda { @ship_transport.load_supplies( 100 ).load_troops( 100 ) }.should raise_error( NA86::Exceptions::NotEnoughCargoCapacity )
    end

    it "transports should now allow aircraft to be loaded" do
      lambda { @ship_transport.load_aircraft( 1 ) }.should raise_error( NA86::Exceptions::CannotLoad )
    end

    it "aircraft carriers should not allow troops or supplies to be loaded" do
      lambda { @ship_carrier.load_supplies( 1 ) }.should raise_error( NA86::Exceptions::CannotLoad )
      lambda { @ship_carrier.load_troops( 1 ) }.should raise_error( NA86::Exceptions::CannotLoad )
    end
  ...
  it "should not allow the same unit to be added more than once" do
    ...
    lambda { @ship_combat.attach( @group_port ) }.should raise_error( NA86::Exceptions::UnitAlreadyAttached ) # second time should fail
  end
  ...
  it "should not allow a unit to be removed if it is not attached" do
    lambda { @ship_combat.unattach }.should raise_error( NA86::Exceptions::UnitNotAttached )
  end
  ...
  context "weapon mounts" do
    it "should return SSM weapons with range of 110 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_SSM, 110 )
      weapons.count.should == 1
      weapons.first.weapon_class.should == NA86::Ordnance::WEAPON_SSM
    end
    it "should return SAM weapons with range of 50 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_SAM, 50 )
      weapons.count.should == 1
      weapons.first.weapon_class.should == NA86::Ordnance::WEAPON_SAM
    end
    it "should return AST weapons with range of 10 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_AST, 10 )
      weapons.count.should == 1
      weapons.first.weapon_class.should == NA86::Ordnance::WEAPON_AST
    end
    it "should return ASW weapons with range of 20 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_ASW, 20 )
      weapons.count.should == 1
      weapons.first.weapon_class.should == NA86::Ordnance::WEAPON_ASW
    end
    it "should return no SSM weapons with range greater than 110 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_SSM, 120 )
      weapons.count.should == 0
    end
    it "should return no SAM weapons with range greater than 50 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_SAM, 60 )
      weapons.count.should == 0
    end
    it "should return no AST weapons with range greater than 10 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_AST, 20 )
      weapons.count.should == 0
    end
    it "should return no ASW weapons with range greater than 20 KM" do
      weapons = @ship_combat.weapons( NA86::Ordnance::WEAPON_ASW, 30 )
      weapons.count.should == 0
    end
  end
end
