...
describe NavalConflict::Group do
  ...
  it "should have a gtype" do
    @group_combat.gtype.should == NavalConflict::Group::TYPE_GROUP_TASK_FORCE
  end
  
  it "is a task force, it should have a mission" do
    @group_combat.mission.should == NavalConflict::Group::TASK_FORCE_MISSION_COMBAT
  end
  ...
  it "should have a condition of active eletronic warfare" do
    ...
    @group_combat.sensor_state.should == NavalConflict::Group::SENSOR_STATE_ACTIVE_EW
  end
  
  it "should have a condition of passive eletronic warfare" do
    @group_combat.passive_ew()
    @group_combat.sensor_state.should == NavalConflict::Group::SENSOR_STATE_PASSIVE_EW
  end
  ...
  it "max speed should never be lower than crippled speed" do
    ...
    @ship_combat.attach @group_combat
    @group_combat.max_speed.should == NavalConflict::Unit::UNIT_MIN_SPEED
  end
